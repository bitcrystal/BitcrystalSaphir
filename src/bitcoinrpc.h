...
extern json_spirit::Value getstakegenerate(const json_spirit::Array& params, bool fHelp); // in rpcmining.cpp
extern json_spirit::Value setstakegenerate(const json_spirit::Array& params, bool fHelp);
