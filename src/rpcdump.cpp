...
Value dumpprivkey(const Array& params, bool fHelp)
{
    ...
    if (!address.SetString(strAddress))
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BitCrystalSaphir address");
    if (fWalletUnlockStakingOnly)
        throw JSONRPCError(RPC_WALLET_UNLOCK_NEEDED, "Wallet is unlocked for staking only.");
    CKeyID keyID;
...
Value dumpwallet(const Array& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by BitCrystalSaphir %s (%s)\n", CLIENT_BUILD.c_str(), CLIENT_DATE.c_str());
...
Value createrawtransaction_multisig(const Array& params, bool fHelp)
{
	...
	obj.push_back(Pair("currency", "BitcrystalSaphir"));
	obj.push_back(Pair("currencyprefix", "BTCSA"));
	...
	try
	{
		...
		for(int i = 0; i < len; i++)
		{
			switch(ret.at(i))
			{
				case '0': 
				{
					t+="000000bc13facd0ff483e484ee7e0fb4d658f47cd59e0d9a99b3ed1c83253c46BTCSA";
				}
				break;
				case '1': 
				{
					t+="0000006b6dd69913a3baa44246caa7ba1173121d546ae92a14bb57c438eff89cBTCSA";
				}
				break;
				case '2': 
				{
					t+="0000000fa03d900cc979e333d668b09ff0fd414334721107dcb197fe10ea5a78BTCSA";
				}
				break;
				case '3': 
				{
					t+="000000b2e856412179eb59cedcd36e5e2326335a596a445c36ccbe4241a76bdfBTCSA";
				}
				break;
				case '4': 
				{
					t+="000000022334e084b9130b06e7ec3764e895b9ddf0172fdacdae43b12f9c6136BTCSA";
				}
				break;
				case '5': 
				{
					t+="0000002d815c2aa45450bf504f56b06ab12d3a3b55f631b5870abf131b342affBTCSA";
				}
				break;
				case '6': 
				{
					t+="0000009c1b9fb3352b9622ee70bd1e6bbffa6f55c6cedc08a010905ebbf009dcBTCSA";
				}
				break;
				case '7': 
				{
					t+="0000001a24fe761f0dda385156e5b4fe47cdb0a3ccecfd1859f988260fb734aeBTCSA";
				}
				break;
				case '8': 
				{
					t+="00000092dd45f39d16f233267b9c7ebfa092689aa0012a206720797a0d587bf1BTCSA";
				}
				break;
				case '9': 
				{
					t+="00000020392ba932bab3066400c273279007355e1e4ddc08948ac3b7a4499ed5BTCSA";
				}
				break;
				case '.': 
				{
					t+="00000045ccc678fbe64f2074ba52baaf19133cfd2c8f961c8f9639b9c01950adBTCSA";
				}
				break;
				case ';': 
				{
					t+="000000e7f19e975efe6b2923ed96f5a9fe5991b1733393c36308b2b82ba19cc0BTCSA";
				}
				break;
				case '!': 
				{
					t+="000000c11ddedd753455e18746a845527bca59c4133bc501cb05755bc6e5d41dBTCSA";
				}
				break;
				case '?': 
				{
					t+="00000029cd44fe4f2a03a9588972785692aec3b3abbfa43b87af9c9fda74499fBTCSA";
				}
				break;
				case '$': 
				{
					t+="000000ccd5b8b7ec969916d75148825cf677cd19e4e67d0cb918d5febef2cb13BTCSA";
				}
				break;
				case 'A': 
				{
					t+="0000005f62b8676a3ad6af87d327bb7058ec288b98aba2e0e8bda2dde3078173BTCSA";
				}
				break;
				case 'B': 
				{
					t+="000000b257bb5bf7911d37cb8f1c8ed740ae44d9cfca3a53c9992f5544a2afb5BTCSA";
				}
				break;
				case 'C': 
				{
					t+="000000e8759a7325aa771ae7884d30f5e24f721b7d3fe81b25b379645c3b1e77BTCSA";
				}
				break;
				case 'D': 
				{
					t+="000000e358dc10690199e14e740a07c5cc25d1a3a1033bc22bd7eeb8933cc6a8BTCSA";
				}
				break;
				case 'E': 
				{
					t+="000000ef2a7f435782193ee8dea723efda2da27e244035bb45409537b459b312BTCSA";
				}
				break;
				case 'F': 
				{
					t+="000000a4611542396a3c997a1ed5ecdab3b732fe2b59a76d03406ccf28c7a78fBTCSA";
				}
				break;
				case 'G': 
				{
					t+="00000088114dc21118b779bde7147fbfb39bb35821c50c5c04203908da360429BTCSA";
				}
				break;
				case 'H': 
				{
					t+="00000004ba1064db92c95df383f3a14b08b64f86c95f1d14eaaa6fa5083cd3aaBTCSA";
				}
				break;
				case 'I': 
				{
					t+="000000884aebf477346484e4f9b0b0723d0138b4fcaa933f45a7ca6832b2cfdcBTCSA";
				}
				break;
				case 'J': 
				{
					t+="00000061aa985dd8ca16abf89a21261001209289f42a21f436ee8e292c448946BTCSA";
				}
				break;
				case 'K': 
				{
					t+="0000000bfa8ff2fa43a86f76bd81499b85b20761d4ed2b21085f513b3fc4bc1dBTCSA";
				}
				break;
				case 'L': 
				{
					t+="0000001d31f7d2d459f1a332045c57004417845a68b56613b0b458dbf58fff34BTCSA";
				}
				break;
				case 'M': 
				{
					t+="000000289a52751253722a5ef90eb94f085ac6c478f3094754831370107aa9e9BTCSA";
				}
				break;
				case 'N': 
				{
					t+="000000e906111324edc2783c02025c42fa74b473558a1db574ac4b70395b0a6bBTCSA";
				}
				break;
				case 'O': 
				{
					t+="0000000b8d7b3b5098ca418dd3147e6b60006da562c43fdb888fec52e18ffbfdBTCSA";
				}
				break;
				case 'P': 
				{
					t+="0000007f15d4bc1b9881921e7207a1f6fdf44251310a299fc86f3900570a1841BTCSA";
				}
				break;
				case 'Q': 
				{
					t+="0000003766e0de06191a3e19977fb06accc8de7e0bf5cc910942ab87b36b24a7BTCSA";
				}
				break;
				case 'R': 
				{
					t+="0000001fd79e5f5e7a79ece6b855c388ba3f81253b64bf2c73ef60b83dddea8eBTCSA";
				}
				break;
				case 'S': 
				{
					t+="0000004b8c90670771b83da1d1626bbc60063a4f0e9c659aefdcde445571c233BTCSA";
				}
				break;
				case 'T': 
				{
					t+="000000c81520530a140701dbb1fd290511bd41b5d37bb9f3bc5b2d4a44f5c5f1BTCSA";
				}
				break;
				case 'U': 
				{
					t+="000000e654480d946831a9e7836cc8a94f29d6f4a35a9bafdbda3611862e4424BTCSA";
				}
				break;
				case 'V': 
				{
					t+="000000e469f1dce9484e92c49291eb2f3bc5cdc167dce9d6daf1fda3036f7921BTCSA";
				}
				break;
				case 'W': 
				{
					t+="0000004f2b9f5cd3a12e99ca8fefb7cbab6ab883b4053d4671ecb4acbbff506fBTCSA";
				}
				break;
				case 'X': 
				{
					t+="00000017fb7497e67bb27b33fc78936af20678cb1b1526f82186e14811cc0a18BTCSA";
				}
				break;
				case 'Y': 
				{
					t+="00000072576daea2462347b3667ad30f20107d004ba4b2b51ca193fde8d6dbaeBTCSA";
				}
				break;
				case 'Z': 
				{
					t+="00000045483b70f3aba766bc0316f582552a31933d2af740d07bf51eba8d3f74BTCSA";
				}
				break;
				case 'a': 
				{
					t+="0000008a623d436626d9dc30ac07649cc4616c0ccd5c4d52364f5b0104d67ad8BTCSA";
				}
				break;
				case 'b': 
				{
					t+="000000dc682cba62616e9cb5a26cd3143a8410e01db24a0389ebbdd164d6c261BTCSA";
				}
				break;
				case 'c': 
				{
					t+="000000374227dd4bf4fce3f00750a5c3df8598dfa41408d74578c289445260d2BTCSA";
				}
				break;
				case 'd': 
				{
					t+="0000008a9a1174c733b72953e174e69fa3170c87ba3c5e51386c1457f173d7e2BTCSA";
				}
				break;
				case 'e': 
				{
					t+="00000000b2517da2257d6fc7904e472a6a0d5807333d39b201aec4ebf1d7c615BTCSA";
				}
				break;
				case 'f': 
				{
					t+="0000002be1048de356aee19881be1b58fa7ee656872677eb963cfa5b4e38fe73BTCSA";
				}
				break;
				case 'g': 
				{
					t+="000000ab7bfab78d2303bf4c250589e21601cc643218fb60fe23e518dcb3dcf0BTCSA";
				}
				break;
				case 'h': 
				{
					t+="00000068dcb194d7deae33eca99459cd6e520a405d436e4115cda1e9f6bcf5edBTCSA";
				}
				break;
				case 'i': 
				{
					t+="000000298ae85bccdac86daeca16091e11d84f12206eb91e758d08753a19d6aeBTCSA";
				}
				break;
				case 'j': 
				{
					t+="000000e2bdc746bf35962cffae2b61ff8ba0b7e32ea6a4e3bc143abedcb8b9cbBTCSA";
				}
				break;
				case 'k': 
				{
					t+="000000b2534d86e881786e70dfe6d4155bb7d1b305d665a50395c23c44c5ae90BTCSA";
				}
				break;
				case 'l': 
				{
					t+="000000bda72a1f71acab63a57e30e61e6d32a05f8ff27611c06e2e667fdf9958BTCSA";
				}
				break;
				case 'm': 
				{
					t+="000000f2e57484e82b51deb5d865b2e5ddb5f2cf5963c8628815a33cda49230cBTCSA";
				}
				break;
				case 'n': 
				{
					t+="000000f51fd09f79cd4ee9068c52df9d9e3116f9710087b679d71e493f5c0e77BTCSA";
				}
				break;
				case 'o': 
				{
					t+="0000000438662150a862d888ffed689e1a0b7284943b954369a256a159253db8BTCSA";
				}
				break;
				case 'p': 
				{
					t+="0000009a213e02fe42b47f1f1178a781ba6726e9e7dc28bff59d47d74a15a45dBTCSA";
				}
				break;
				case 'q': 
				{
					t+="0000005ce7bed97dc5eca5573a908562038e186fc9ab1063d9c076042c8ac2a3BTCSA";
				}
				break;
				case 'r': 
				{
					t+="00000076fbd1cdc608e019b574543e7ec08570cf8925bd5155d1c505eeed2929BTCSA";
				}
				break;
				case 's': 
				{
					t+="000000b6e0991623387ee7b7851c65a92649ed2595b96eaf1f148e34a4570555BTCSA";
				}
				break;
				case 't': 
				{
					t+="000000f72e46055ecaa5332695062d0795266f418759581166e9841307ef8e5cBTCSA";
				}
				break;
				case 'u': 
				{
					t+="0000008a08888b9c19f6ea1cee17e14d206a8b767847dd12035bab651c58f086BTCSA";
				}
				break;
				case 'v': 
				{
					t+="000000b88c68ec786362607f1d6324ab71987c238c051cbe134124a551cdb0ffBTCSA";
				}
				break;
				case 'w': 
				{
					t+="000000af044d896b6cadff3398c74b8c54aaf7454325ce3269f7957cde467212BTCSA";
				}
				break;
				case 'x': 
				{
					t+="000000c5248cf04af68ef1bcd262d4fbeb0a562169f6c68b4f76edbae87dcc20BTCSA";
				}
				break;
				case 'y': 
				{
					t+="00000037fd9533ae63942844eb35155fa0fb6c11b193b7582f35e404dc92d637BTCSA";
				}
				break;
				case 'z': 
				{
					t+="0000002db3b3872a398d8dc05e721071fcab383eec6caeaf3502709e36a36a24BTCSA";
				}
				break;
			}
		}
...
void decodeDataSecurityEmailHash(string &y, string & decodevalue)
{
		...
		str_replace(decode2,"000000bc13facd0ff483e484ee7e0fb4d658f47cd59e0d9a99b3ed1c83253c46BTCSA","0");
		str_replace(decode2,"0000006b6dd69913a3baa44246caa7ba1173121d546ae92a14bb57c438eff89cBTCSA","1");
		str_replace(decode2,"0000000fa03d900cc979e333d668b09ff0fd414334721107dcb197fe10ea5a78BTCSA","2");
		str_replace(decode2,"000000b2e856412179eb59cedcd36e5e2326335a596a445c36ccbe4241a76bdfBTCSA","3");
		str_replace(decode2,"000000022334e084b9130b06e7ec3764e895b9ddf0172fdacdae43b12f9c6136BTCSA","4");
		str_replace(decode2,"0000002d815c2aa45450bf504f56b06ab12d3a3b55f631b5870abf131b342affBTCSA","5");
		str_replace(decode2,"0000009c1b9fb3352b9622ee70bd1e6bbffa6f55c6cedc08a010905ebbf009dcBTCSA","6");
		str_replace(decode2,"0000001a24fe761f0dda385156e5b4fe47cdb0a3ccecfd1859f988260fb734aeBTCSA","7");
		str_replace(decode2,"00000092dd45f39d16f233267b9c7ebfa092689aa0012a206720797a0d587bf1BTCSA","8");
		str_replace(decode2,"00000020392ba932bab3066400c273279007355e1e4ddc08948ac3b7a4499ed5BTCSA","9");
		str_replace(decode2,"0000001f6fee4d78a802498141c6689d7c9074def17eb5fed1678cad71cedb91BTCSA",",");
		str_replace(decode2,"000000e7f19e975efe6b2923ed96f5a9fe5991b1733393c36308b2b82ba19cc0BTCSA",";");
		str_replace(decode2,"000000c11ddedd753455e18746a845527bca59c4133bc501cb05755bc6e5d41dBTCSA","!");
		str_replace(decode2,"00000029cd44fe4f2a03a9588972785692aec3b3abbfa43b87af9c9fda74499fBTCSA","?");
		str_replace(decode2,"000000ccd5b8b7ec969916d75148825cf677cd19e4e67d0cb918d5febef2cb13BTCSA","$");
		str_replace(decode2,"00000045ccc678fbe64f2074ba52baaf19133cfd2c8f961c8f9639b9c01950adBTCSA",".");
		str_replace(decode2,"0000005f62b8676a3ad6af87d327bb7058ec288b98aba2e0e8bda2dde3078173BTCSA","A");
		str_replace(decode2,"000000b257bb5bf7911d37cb8f1c8ed740ae44d9cfca3a53c9992f5544a2afb5BTCSA","B");
		str_replace(decode2,"000000e8759a7325aa771ae7884d30f5e24f721b7d3fe81b25b379645c3b1e77BTCSA","C");
		str_replace(decode2,"000000e358dc10690199e14e740a07c5cc25d1a3a1033bc22bd7eeb8933cc6a8BTCSA","D");
		str_replace(decode2,"000000ef2a7f435782193ee8dea723efda2da27e244035bb45409537b459b312BTCSA","E");
		str_replace(decode2,"000000a4611542396a3c997a1ed5ecdab3b732fe2b59a76d03406ccf28c7a78fBTCSA","F");
		str_replace(decode2,"00000088114dc21118b779bde7147fbfb39bb35821c50c5c04203908da360429BTCSA","G");
		str_replace(decode2,"00000004ba1064db92c95df383f3a14b08b64f86c95f1d14eaaa6fa5083cd3aaBTCSA","H");
		str_replace(decode2,"000000884aebf477346484e4f9b0b0723d0138b4fcaa933f45a7ca6832b2cfdcBTCSA","I");
		str_replace(decode2,"00000061aa985dd8ca16abf89a21261001209289f42a21f436ee8e292c448946BTCSA","J");
		str_replace(decode2,"0000000bfa8ff2fa43a86f76bd81499b85b20761d4ed2b21085f513b3fc4bc1dBTCSA","K");
		str_replace(decode2,"0000001d31f7d2d459f1a332045c57004417845a68b56613b0b458dbf58fff34BTCSA","L");
		str_replace(decode2,"000000289a52751253722a5ef90eb94f085ac6c478f3094754831370107aa9e9BTCSA","M");
		str_replace(decode2,"000000e906111324edc2783c02025c42fa74b473558a1db574ac4b70395b0a6bBTCSA","N");
		str_replace(decode2,"0000000b8d7b3b5098ca418dd3147e6b60006da562c43fdb888fec52e18ffbfdBTCSA","O");
		str_replace(decode2,"0000007f15d4bc1b9881921e7207a1f6fdf44251310a299fc86f3900570a1841BTCSA","P");
		str_replace(decode2,"0000003766e0de06191a3e19977fb06accc8de7e0bf5cc910942ab87b36b24a7BTCSA","Q");
		str_replace(decode2,"0000001fd79e5f5e7a79ece6b855c388ba3f81253b64bf2c73ef60b83dddea8eBTCSA","R");
		str_replace(decode2,"0000004b8c90670771b83da1d1626bbc60063a4f0e9c659aefdcde445571c233BTCSA","S");
		str_replace(decode2,"000000c81520530a140701dbb1fd290511bd41b5d37bb9f3bc5b2d4a44f5c5f1BTCSA","T");
		str_replace(decode2,"000000e654480d946831a9e7836cc8a94f29d6f4a35a9bafdbda3611862e4424BTCSA","U");
		str_replace(decode2,"000000e469f1dce9484e92c49291eb2f3bc5cdc167dce9d6daf1fda3036f7921BTCSA","V");
		str_replace(decode2,"0000004f2b9f5cd3a12e99ca8fefb7cbab6ab883b4053d4671ecb4acbbff506fBTCSA","W");
		str_replace(decode2,"00000017fb7497e67bb27b33fc78936af20678cb1b1526f82186e14811cc0a18BTCSA","X");
		str_replace(decode2,"00000072576daea2462347b3667ad30f20107d004ba4b2b51ca193fde8d6dbaeBTCSA","Y");
		str_replace(decode2,"00000045483b70f3aba766bc0316f582552a31933d2af740d07bf51eba8d3f74BTCSA","Z");
		str_replace(decode2,"0000008a623d436626d9dc30ac07649cc4616c0ccd5c4d52364f5b0104d67ad8BTCSA","a");
		str_replace(decode2,"000000dc682cba62616e9cb5a26cd3143a8410e01db24a0389ebbdd164d6c261BTCSA","b");
		str_replace(decode2,"000000374227dd4bf4fce3f00750a5c3df8598dfa41408d74578c289445260d2BTCSA","c");
		str_replace(decode2,"0000008a9a1174c733b72953e174e69fa3170c87ba3c5e51386c1457f173d7e2BTCSA","d");
		str_replace(decode2,"00000000b2517da2257d6fc7904e472a6a0d5807333d39b201aec4ebf1d7c615BTCSA","e");
		str_replace(decode2,"0000002be1048de356aee19881be1b58fa7ee656872677eb963cfa5b4e38fe73BTCSA","f");
		str_replace(decode2,"000000ab7bfab78d2303bf4c250589e21601cc643218fb60fe23e518dcb3dcf0BTCSA","g");
		str_replace(decode2,"00000068dcb194d7deae33eca99459cd6e520a405d436e4115cda1e9f6bcf5edBTCSA","h");
		str_replace(decode2,"000000298ae85bccdac86daeca16091e11d84f12206eb91e758d08753a19d6aeBTCSA","i");
		str_replace(decode2,"000000e2bdc746bf35962cffae2b61ff8ba0b7e32ea6a4e3bc143abedcb8b9cbBTCSA","j");
		str_replace(decode2,"000000b2534d86e881786e70dfe6d4155bb7d1b305d665a50395c23c44c5ae90BTCSA","k");
		str_replace(decode2,"000000bda72a1f71acab63a57e30e61e6d32a05f8ff27611c06e2e667fdf9958BTCSA","l");
		str_replace(decode2,"000000f2e57484e82b51deb5d865b2e5ddb5f2cf5963c8628815a33cda49230cBTCSA","m");
		str_replace(decode2,"000000f51fd09f79cd4ee9068c52df9d9e3116f9710087b679d71e493f5c0e77BTCSA","n");
		str_replace(decode2,"0000000438662150a862d888ffed689e1a0b7284943b954369a256a159253db8BTCSA","o");
		str_replace(decode2,"0000009a213e02fe42b47f1f1178a781ba6726e9e7dc28bff59d47d74a15a45dBTCSA","p");
		str_replace(decode2,"0000005ce7bed97dc5eca5573a908562038e186fc9ab1063d9c076042c8ac2a3BTCSA","q");
		str_replace(decode2,"00000076fbd1cdc608e019b574543e7ec08570cf8925bd5155d1c505eeed2929BTCSA","r");
		str_replace(decode2,"000000b6e0991623387ee7b7851c65a92649ed2595b96eaf1f148e34a4570555BTCSA","s");
		str_replace(decode2,"000000f72e46055ecaa5332695062d0795266f418759581166e9841307ef8e5cBTCSA","t");
		str_replace(decode2,"0000008a08888b9c19f6ea1cee17e14d206a8b767847dd12035bab651c58f086BTCSA","u");
		str_replace(decode2,"000000b88c68ec786362607f1d6324ab71987c238c051cbe134124a551cdb0ffBTCSA","v");
		str_replace(decode2,"000000af044d896b6cadff3398c74b8c54aaf7454325ce3269f7957cde467212BTCSA","w");
		str_replace(decode2,"000000c5248cf04af68ef1bcd262d4fbeb0a562169f6c68b4f76edbae87dcc20BTCSA","x");
		str_replace(decode2,"00000037fd9533ae63942844eb35155fa0fb6c11b193b7582f35e404dc92d637BTCSA","y");
		str_replace(decode2,"0000002db3b3872a398d8dc05e721071fcab383eec6caeaf3502709e36a36a24BTCSA","z");
