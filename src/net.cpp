...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitCrystalSaphir " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seednode1", "176.57.142.30"},
	{"seednode2", "176.57.128.72"},
	{"seednode3", "84.200.27.213"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("BitCrystalSaphir-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitCrystalSaphir is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BitCrystalSaphir-start");
